...
print("Ends with e:")
b = [person.name for person in humans if person.name[len(
    person.name)-1] == 'e']
print(b)
...
c_to_g = ["C", "D", "E", "F", "G"]
c = [person.name for person in humans if person.name[0] in c_to_g]
print(c)
...
new_humans = humans
g = [Human(person.name.upper(), person.age+5) for person in new_humans]
print(g)
